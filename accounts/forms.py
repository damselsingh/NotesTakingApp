...
class noteForm(forms.ModelForm):
    class Meta:
        model = note
        fields = ['title', 'takenotes']
        widgets = {'takenotes': forms.Textarea(attrs = {'class': 'form-control'}), 'title': forms.TextInput(attrs = {'class': 'form-control'})}
        labels = {'takenotes': 'Write here :', 'title': 'Topic :'}
